...
public class ConstantSQL {
	...
	/** 全件表示 */
	public static final String SQL_ALL_SELECT        = "SELECT " +
												          "e.emp_id," +
												          " e.emp_name," +
												          "e.gender, " +
												          "TO_CHAR(birthday, 'yyyy/MM/dd')" +
												          " AS birthday,e.birthday, d.dept_name " +
												          "FROM " +
												          "employee e " +
	...
	/** 条件検索(ベース) */
	public static final String SQL_SELECT_BASIC       = "SELECT " +
													       "e.emp_id," +
												           " e.emp_name," +
													       "e.gender, " +
													       "TO_CHAR(birthday, 'yyyy/MM/dd')" +
													       " AS  birthday, e.birthday, d.dept_name, d.dept_id " +
													       "FROM " +

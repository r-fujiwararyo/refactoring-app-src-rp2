...
public class ConstantMsg {
	...
	public static final String UPDATE_STRING                                  = "5.更新";
	
	public static final String EMPLOYEE_DELETE_STRING					    = "6.削除";
	...
	public static final String EMPLOYEE_DEPT_ID_INPUT_STRING               = "部署ID(1:営業部、2:経理部、3:総務部)を入力してください:";
	
	public static final String GENDER_INPUT_STRING          				    = "性別(0:その他, 1:男性, 2:女性, 9:回答なし):";
}
